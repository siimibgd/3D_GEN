...
fused_depth_path = os.path.join(save_directory, "fused_depth.npy")

if not os.path.exists(fused_depth_path):
    print("❌ ERROR: No fused depth map found! Run 'fuse_depth_maps.py' first.")
    exit()
